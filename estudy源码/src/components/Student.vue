<template>
    <div>
        <a-table :columns="columns" :dataSource="student.assignments" :rowKey="assignment => assignment.assignment_id" :pagination="false">
            <template #operation="record">
                ...
                <a :href="`${downloadHost}?id=${record.work.id}&type=student`" v-if="record.work">
        ...
        <a-modal title="批改意见" :visible="Boolean(visible)" @cancel="visible = false">
